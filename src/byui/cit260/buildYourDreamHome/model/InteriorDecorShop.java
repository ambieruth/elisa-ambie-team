 ...
 */
public class InteriorDecorShop implements Serializable{
    ...
    public String toString() {
        return "InteriorDecorShop{" + "description=" + description + ", travelTime=" + travelTime + ", blocked=" + blocked + ", symbol=" + symbol + ", noOfItems=" + noOfItems + '}';
    }
    ...
    public boolean equals(Object obj) {
        ...
        final InteriorDecorShop other = (InteriorDecorShop) obj;
